...
The content of this project is licensed under the [Creative Commons Attribution-NonCommercial-NoDerivatives 4.0 International](https://creativecommons.org/licenses/by-nc-nd/4.0/), while the underlying source code that structures and displays this content is licensed under the [MIT License](https://github.com/dreibona/dreibona.com/blob/main/LICENSE.md)
